...
values
  ...
  $json$::jsonb, 'published'),
  ('act-dictation-v1', 'mission-introduce-yourself-v1', 5, 'dictation_placeholder', $json$
    {"id":"act-dictation-v1","type":"dictation_placeholder","prompt":"Dictation practice: type the phrase you hear.","promptFrenchSegments":[],"helperText":"Play the audio, then type what you hear.","targetText":"Je m'appelle Jamie.","placeholder":"Type the phrase","contentItemIds":["phrase-je-mappelle-v1"],"grammarRuleIds":[],"estimatedSeconds":40,"acceptedAnswers":[{"value":"Je m'appelle Jamie"}],"feedbackCorrect":"Nice. You matched the sounds to the words.","feedbackIncorrect":"The target phrase is: Je m'appelle Jamie."}
  $json$::jsonb, 'published'),
  ('act-speak-repeat-v1', 'mission-introduce-yourself-v1', 6, 'speak_repeat_placeholder', $json$
    {"id":"act-speak-repeat-v1","type":"speak_repeat_placeholder","prompt":"Say this out loud: Aujourd'hui, j'étudie le français.","promptFrenchSegments":["Aujourd'hui, j'étudie le français."],"helperText":"This is a speaking self-check. No recording, transcription, or pronunciation score is used.","targetText":"Aujourd'hui, j'étudie le français.","contentItemIds":["phrase-aujourdhui-v1"],"grammarRuleIds":[],"estimatedSeconds":30,"acceptedAnswers":[{"value":"completed"}],"feedbackCorrect":"Good work. Notice the rhythm: aujourd'hui | j'étudie | le français.","feedbackIncorrect":"Try the phrase once more at a comfortable pace."}
  $json$::jsonb, 'published'),
