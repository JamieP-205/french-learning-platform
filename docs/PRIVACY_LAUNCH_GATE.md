# 13+ Privacy Launch Gate

Current onboarding uses a 13+ self-declaration and records required terms, privacy, and tutor consents. It does not use the legacy `country_age_policies` table from the initial schema.
